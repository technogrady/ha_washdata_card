...
const TRANSLATIONS = {
  ...
  "lt": {
    ...
    "pct_entity": "Pažangos objektas (nebūtina)",
  ...
  "sr-Latn": {
    ...
    "spin_icon": "Икона која се окреће (док трчите)",
  ...
  "uk": {
    ...
    "program_entity": "Сутність програми",
